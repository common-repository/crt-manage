...
(function($, api) {
   ...
   api.sectionConstructor['crt-manage-upsell'] = api.Section.extend({
   ...
   const crt_manage_section_lists = ['banner','skill','experience','gallery','blog','cta'];
    crt_manage_section_lists.forEach(crt_manage_homepage_scroll);

   function crt_manage_homepage_scroll(item, index) {
        // Detect when the front page sections section is expanded (or closed) so we can adjust the preview accordingly.
        item = item.replace(/-/g, '_');
        wp.customize.section('crt_manage_' + item + '_section', function(section) {
