...
if ( class_exists( 'WP_Customize_Control' ) ) {
    ...
    class Crt_Manage_Customize_Field_Repeater extends WP_Customize_Control {
        ...
        public function enqueue() {
            wp_enqueue_style( 'font-awesome', get_template_directory_uri().'/assets/css/font-awesome.css', array(), CRT_MANAGE_VERSION );
            wp_enqueue_style( 'crt-manage-customizer-repeater-admin-stylesheet', get_template_directory_uri().'/assets/css/admin-style.css', array(), CRT_MANAGE_VERSION );
            wp_enqueue_style( 'wp-color-picker' );
            wp_enqueue_script( 'crt-manage-customizer-customizer-repeater-script', get_template_directory_uri() . '/assets/js/customizer_repeater.js', array('jquery', 'jquery-ui-draggable', 'wp-color-picker' ), CRT_MANAGE_VERSION, true  );
            wp_enqueue_script( 'crt-manage-customizer-repeater-fontawesome-iconpicker', get_template_directory_uri() . '/assets/js/fontawesome-iconpicker.js', array( 'jquery' ), CRT_MANAGE_VERSION, true );
            wp_enqueue_style( 'crt-manage-customizer-repeater-fontawesome-iconpicker-script', get_template_directory_uri() . '/assets/css/fontawesome-iconpicker.min.css', array(), CRT_MANAGE_VERSION );
        }
                    ...
                    <div class="customizer-repeater-general-control-repeater-container customizer-repeater-draggable">
                        ...
                        <div class="customizer-repeater-box-content-hidden">
                            ...
                            if($this->custom_repeater_title_control==true){
                                $this->input_control(array(
                                    'label' => apply_filters('repeater_input_labels_filter', esc_html__( 'Title','crt-manage' ), $this->id, 'custom_repeater_title_control' ),
                            ...
                            if($this->custom_repeater_subtitle_control==true){
                                $this->input_control(array(
                                    'label' => apply_filters('repeater_input_labels_filter', esc_html__( 'Subtitle','crt-manage' ), $this->id, 'custom_repeater_subtitle_control' ),
                            ...
                            if($this->custom_repeater_text_control==true){
                                $this->input_control(array(
                                    'label' => apply_filters('repeater_input_labels_filter', esc_html__( 'Text','crt-manage' ), $this->id, 'custom_repeater_text_control' ),
                            ...
                            if($this->custom_repeater_link_control){
                                $this->input_control(array(
                                    'label' => apply_filters('repeater_input_labels_filter', esc_html__( 'Link','crt-manage' ), $this->id, 'custom_repeater_link_control' ),
                            ...
                            if($this->custom_repeater_text2_control==true){
                                $this->input_control(array(
                                    'label' => apply_filters('repeater_input_labels_filter', esc_html__( 'Text','crt-manage' ), $this->id, 'custom_repeater_text2_control' ),
        ...
        private function image_control($value = '', $show = '', $attrs = array()){ ?>
            ...
            <span class="customize-control-title">
                ...
                <input type="button" class="button button-secondary customizer-repeater-custom-media-button" value="<?php printf(__('Upload Image', 'crt-manage'), $attrs['class']); ?>" />
            </div>
            <?php
        }
